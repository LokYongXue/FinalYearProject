...
This project focuses on the reimplementation of the GIWRF (Gini Impurity Weighted Random Forest) feature selection technique based on a published research paper and its application to the TON_IoT Network Dataset. The dataset contains 46 features related to network traffic and IoT environments.
